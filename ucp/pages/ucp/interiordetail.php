...
elseif ($_GET['param3'] == "update" and $credits >= 25)
{
	...
	if (!$error)
	{
		...
		if (count($queries) > 251)
		{
			$error = true;
			echo 'Error: The map has exceeded the maximum number of objects (250).<BR />';
		}
	}
	...
	if ($error)
	{
		...
		echo " Done<BR /><BR />";
		echo "The map has been submitted to the vG mapping team, and they will validate the map as soon as possible.";	
	}
