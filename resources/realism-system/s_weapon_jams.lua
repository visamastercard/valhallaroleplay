...
function weaponJammed()
	exports['anticheat-system']:changeProtectedElementDataEx(source, "jammed", 1, false)
end
addEvent("jammed", true)
addEventHandler("jammed", getRootElement(), weaponJammed)

function weaponUnjammed()
	exports['anticheat-system']:changeProtectedElementDataEx(source, "jammed", 0, false)
end
