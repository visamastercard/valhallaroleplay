		...
		if (myCommandsWindow == nil) then
			...
			local commands =
			{
				...
				},
				{
					...
					{ "HEX", "/towtruck", "Calls a towtruck to your current location.", "/towtruck" },
					{ "HEX", "/resettowbackup", "Removes the blip created with /towtruck.", "/resettowbackup" },
					{ "HEX", "/impoundbike", "Sets a Bike that is in the impound lot as impounded.", "/impoundbike" },
					{ "HEX", "/unimpound [vehicle id]", "Sets a vehicle in the HEX Lot and unimpounded.", "/unimpound" },
